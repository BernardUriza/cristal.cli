...
namespace Cristal.CLI.Ritual
{
    ...
    public class SymbolicTrigger : MonoBehaviour, IInteractable
    {
        ...
        public string InteractionPrompt => CanInteract() ? _interactionPrompt : _lockedPrompt;
        public bool CanInteract() => _isEnabled && !IsOnCooldown && MeetsConditions();
        ...
        {
            if (!_isInProximity || !CanInteract()) return;
        ...
        {
            if (!_isInProximity || _playerTransform == null || !CanInteract()) return;
        ...
        private CristalState GetCurrentState()
        {
            ...
            return stateMachine?.CurrentState ?? CristalState.Waiting;
        }
