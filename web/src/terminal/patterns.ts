...
export const DEFAULT_PATTERNS: ResponsePattern[] = [
  ...
  { id: "emotional_fear", priority: 5, keywords: ["afraid", "scared", "fear", "terrified", "lost", "alone"], responseSet: "emotional_fear", level: "narrative", stateTransition: "SEEKING" },
  { id: "emotional_hope", priority: 5, keywords: ["hope", "light", "love", "peace", "warm"], responseSet: "emotional_hope", level: "narrative" },
